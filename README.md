...
- **Retirer une étiquette lead chaud** : ajouter le pseudo Insta dans `ETQ_RETIREES` (index.html, près de `isTestRow`). L'URL reste dans le Sheet EOD, la page l'ignore partout (vivier, onglet Leads, compteur EOD). Fait le 08/09/2026 pour alexandre.lsz, dams69320, banibani_j.
